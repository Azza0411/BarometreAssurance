    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display:"flex", alignItems:"center", gap:10, marginBottom:14 }}>
          ...
          <span style={{ fontSize:9, fontWeight:900, letterSpacing:"3px", textTransform:"uppercase", color:Y, fontFamily:FONT }}>
            À LA UNE
          </span>
        </div>
        ...
        <div style={{ display:"flex", alignItems:"center", gap:7, flexWrap:"wrap", marginBottom:14 }}>
          ...
          <span style={{
            ...
            background:"rgba(255,255,255,.12)", padding:"3px 10px", borderRadius:4, fontFamily:FONT,
          }}>{item.src === "ILBOURSA" ? "IlBoursa" : "Atlas Magazine"}</span>
          <span style={{
            fontSize:9.5, fontWeight:600, color:"rgba(255,255,255,.55)",
            background:"rgba(255,255,255,.07)", padding:"3px 10px", borderRadius:4, fontFamily:FONT,
          }}>{item.date}</span>
        </div>

        <div style={{
          fontFamily: NEWS_FONT, fontSize: 24, fontWeight: 900,
      ...
      <div style={{ flex:1, position:"relative", overflow:"hidden", background:"#1a1a2e" }}>
        {hasImg ? (
          <img key={item.image} src={item.image} alt={item.titre} style={{
      ...
      <button onClick={() => setIdx(i => (i - 1 + items.length) % items.length)} style={{ ...navBtnBase, left:12 }}>
      ...
      <button onClick={() => setIdx(i => (i + 1) % items.length)} style={{ ...navBtnBase, right:12 }}>
        <svg viewBox="0 0 12 12" fill="none" stroke="white" strokeWidth="2.2" width="10" height="10">
        ...
        <div className="logo-track-wrap" style={{ overflow:"hidden", position:"relative" }}>
          ...
          <div className="logo-track">
            {doubled.map(({ key, logo }, i) => {
              ...
              return (
                <div key={i} className={`logo-item${active ? " active" : ""}`}
                  onClick={() => onSelect(active ? null : key)} title={key}>
                  <img src={logo} alt={key} style={{
                  ...
                  <span style={{
                    ...
                    whiteSpace:"nowrap", fontFamily:FONT, transition:"color .15s",
        ...
        <div style={{
          ...
          <div style={{ display:"flex", alignItems:"center", gap:8,
            ...
            <input value={search} onChange={e => { setSearch(e.target.value); setPage(1); }}
              placeholder="Titre, compagnie, source, date…"
          ...
          <table style={{ width:"100%", borderCollapse:"collapse", fontSize:12 }}>
            <thead>
              <tr>
                ...
                <th style={{ ...thStyle, width:"28%" }} onClick={() => toggleSort("titre")}>Actualité <SortIcon col="titre"/></th>
        ...
        <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", padding:"4px 0", flexWrap:"wrap", gap:10 }}>
          <div style={{ display:"flex", alignItems:"center", gap:10 }}>
            <span style={{ fontSize:12, color:G }}>
              Affichage de <b style={{ color:D }}>{from}</b> à <b style={{ color:D }}>{to}</b> sur <b style={{ color:D }}>{filtered.length}</b> actualité{filtered.length !== 1 ? "s" : ""}
            </span>
