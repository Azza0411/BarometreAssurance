...
function EntrepriseLogoGrid({ societes, selected, onToggle, onOnly, disabledSet, onReset, hasExclusions }) {
  ...
  return (
    <div>
      ...
      {/* Toutes les sociétés restent affichées en permanence (retour
          utilisateur) — sélectionnée = pleine couleur, exclue = grisée, mais
          jamais masquée. Un bouton "Seulement" au survol isole une société
          en un clic (comme "Solo" sur un calque Figma) plutôt que d'avoir à
          en désélectionner beaucoup d'autres. */}
