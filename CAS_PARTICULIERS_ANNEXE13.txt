...
| BIAT (par analogie, non vérifié composant par composant comme pour l'Annexe 12) | Découvert le 2026-08-05 en corrigeant le même bug côté Annexe 12 (voir CAS_PARTICULIERS_ANNEXE12.md) : le titre de la page "par catégorie" de BIAT est "RESULTAT TECHNIQUE NON VIE PAR CATEGORIE D'ASSURANCE" (mot "NON VIE" intercalé entre "TECHNIQUE" et "PAR"), non couvert par `PAGE_TITLE_RE` qui supposait ce mot toujours en fin de titre. Vérifié présent sur BIAT_2024.pdf (page Annexe 13). | **Fixé par précaution** (même correctif que l'Annexe 12, motif élargi avec un "non vie "/"vie " optionnel) — impact réel sur les KPI Non-Vie de BIAT non mesuré isolément (BIAT étant "vie"-only par contexte métier, ses ratios affichés ne dépendent pas des composantes Non-Vie), mais corrige la même classe de bug pour toute société non-vie/mixte partageant cette formulation de titre. |
